...
if %ERRORLEVEL% EQU 0 (
    ...
    python "C:\users\chenn\mtkbrute\mtkclient\mtk.py" w lk1 "C:\users\chenn\mtkbrute\mtk_build\fixed\k39tv1-kaeru.bin" lk2 "C:\users\chenn\mtkbrute\mtk_build\fixed\k39tv1-kaeru.bin"
